...
This project is indexed by GitNexus as **memesploding** (5120 symbols, 11027 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
