...
* **FR 2.1: Tìm trận nhanh (Quick Match):** Hệ thống tự động tìm kiếm các phòng chơi còn chỗ trống để đưa người chơi vào một cách ngẫu nhiên. 
* **FR 2.2: Tạo phòng tùy chỉnh (Custom Room):**
    ...
    * Chọn visibility của phòng là public hoặc private. Phòng public sẽ được hiển thị trên danh sách phòng trên lobby. 
- **FR 2.3: Xem danh sách phòng**: Cho phép người chơi xem danh sách các phòng public, có bộ lọc theo tổ hợp bộ bài sử dụng và số người chơi tối đa. 
- **FR 2.4: Vào phòng:** Người chơi có thể vào phòng trong danh sách phòng public hoặc thông qua link mời, mã mời, bạn bè mời, xin bạn bè cho vào phòng.
