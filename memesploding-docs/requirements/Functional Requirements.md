...
* **FR 1.1: Chế độ Khách (Guest):** Hệ thống cho phép người chơi tham gia trải nghiệm game ngay lập tức mà không cần đăng ký. Dữ liệu (tiền, cấp độ) của khách sẽ được lưu tạm thời trên thiết bị hiện tại.
...
* **FR 1.3: Hồ sơ cá nhân (Profile):**
    ...
    * Thống kê trận đấu: Hiển thị tổng số trận đã chơi, số trận thắng, tỷ lệ thắng, cấp độ (Level) và điểm kinh nghiệm (XP).
* **FR 1.4: Hệ thống Tiền tệ (Meme Coins):** Hệ thống lưu trữ và quản lý số dư tiền ảo của người chơi. Tiền ảo được dùng để mua các vật phẩm trang trí (Skin, Sticker) trong tương lai.
...
* **FR 2.1: Tìm trận nhanh (Quick Match):** Hệ thống tự động tìm kiếm các phòng chơi công khai (Public) còn chỗ trống để đưa người chơi vào. Nếu không tìm thấy phòng phù hợp, hệ thống sẽ tự động tạo một phòng mới.
* **FR 2.2: Danh sách phòng (Lobby Browser):** Hiển thị danh sách các phòng chơi đang ở trạng thái chờ (Waiting). Người chơi có thể xem và lọc các thông tin như: Tên phòng, Số lượng người hiện có (ví dụ: 3/6), Các bộ bài mở rộng đang sử dụng.
* **FR 2.3: Tạo phòng tùy chỉnh (Custom Room):**
    * Cho phép người chơi thiết lập Tên phòng, Số người chơi (2-6 người) và Mật khẩu (đối với phòng riêng tư).
    * Tùy chỉnh cấu hình trận đấu: Chọn sử dụng bộ bài Cơ bản hoặc kết hợp thêm các bộ mở rộng (Imploding, Barking, Streaking).
* **FR 2.4: Phòng chờ (Waiting Room):**
...
* **FR 2.5: Chia sẻ phòng:** Hỗ trợ tạo mã phòng hoặc liên kết (Link) để người chơi có thể gửi cho bạn bè tham gia trực tiếp vào phòng.
...
* **FR 4.3: Hệ thống Thông báo (Notification System):**
    ...
    * Thông báo kết quả sau khi trận đấu kết thúc bao gồm: Thăng cấp (Level up), nhận thưởng tiền ảo (Meme Coins).
...
* **FR 5.4: Xử lý sự cố máy chủ (Server Failure Handling):** Trong trường hợp máy chủ gặp sự cố nghiêm trọng khiến trận đấu bị hủy bỏ, hệ thống nên có cơ chế hoàn trả hoặc đền bù công bằng cho các bên tham gia (nếu có hệ thống đặt cược hoặc phần thưởng).
